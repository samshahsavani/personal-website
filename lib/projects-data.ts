...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    fullContent: {
      overview: "Before ZoningPal, I co-founded Stoop with Alireza, a furniture sharing app for Toronto. The idea was simple: connect people getting rid of furniture with neighbors who need it. Thousands of people used it to keep furniture out of landfills.",
